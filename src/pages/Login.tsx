      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-[0_16px_48px_rgba(17,17,17,0.12)] p-8 md:p-12">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[var(--color-accent)]">Log in to manage your bookings</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-sm text-[var(--color-accent)]">Remember me</span>
              </label>
          ...
          <div className="mt-8 pt-6 border-t border-[var(--color-border)]">
            <div className="text-center mb-4">
              <span className="text-sm text-[var(--color-accent)]">Or continue with</span>
            </div>
